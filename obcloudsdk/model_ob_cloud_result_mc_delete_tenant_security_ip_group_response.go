...
// checks if the OBCloudResultMcDeleteTenantSecurityIpGroupResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultMcDeleteTenantSecurityIpGroupResponse{}

// OBCloudResultMcDeleteTenantSecurityIpGroupResponse struct for OBCloudResultMcDeleteTenantSecurityIpGroupResponse
type OBCloudResultMcDeleteTenantSecurityIpGroupResponse struct {
	Success *bool `json:"success,omitempty"`
	ErrorCode *string `json:"errorCode,omitempty"`
	ErrorMessage *string `json:"errorMessage,omitempty"`
	Data *McDeleteTenantSecurityIpGroupResponse `json:"data,omitempty"`
...
func NewOBCloudResultMcDeleteTenantSecurityIpGroupResponse() *OBCloudResultMcDeleteTenantSecurityIpGroupResponse {
	this := OBCloudResultMcDeleteTenantSecurityIpGroupResponse{}
	return &this
}
...
func (o *OBCloudResultMcDeleteTenantSecurityIpGroupResponse) GetData() McDeleteTenantSecurityIpGroupResponse {
	if o == nil || IsNil(o.Data) {
		var ret McDeleteTenantSecurityIpGroupResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given McDeleteTenantSecurityIpGroupResponse and assigns it to the Data field.
...
func (o *OBCloudResultMcDeleteTenantSecurityIpGroupResponse) HasCost() bool {
	if o != nil && !IsNil(o.Cost) {
		return true
	}
...
func (o OBCloudResultMcDeleteTenantSecurityIpGroupResponse) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultMcDeleteTenantSecurityIpGroupResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse struct {
	value *OBCloudResultMcDeleteTenantSecurityIpGroupResponse
	isSet bool
}

func (v NullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse) Get() *OBCloudResultMcDeleteTenantSecurityIpGroupResponse {
	return v.value
}

func (v *NullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse) Set(val *OBCloudResultMcDeleteTenantSecurityIpGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse(val *OBCloudResultMcDeleteTenantSecurityIpGroupResponse) *NullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse {
	return &NullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse{value: val, isSet: true}
}

func (v NullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultMcDeleteTenantSecurityIpGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
