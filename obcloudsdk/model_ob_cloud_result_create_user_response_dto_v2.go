...
// checks if the OBCloudResultCreateUserResponseDtoV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultCreateUserResponseDtoV2{}

// OBCloudResultCreateUserResponseDtoV2 struct for OBCloudResultCreateUserResponseDtoV2
type OBCloudResultCreateUserResponseDtoV2 struct {
	Success *bool `json:"success,omitempty"`
	ErrorCode *string `json:"errorCode,omitempty"`
	ErrorMessage *string `json:"errorMessage,omitempty"`
	Data *CreateUserResponseDtoV2 `json:"data,omitempty"`
...
func NewOBCloudResultCreateUserResponseDtoV2() *OBCloudResultCreateUserResponseDtoV2 {
	this := OBCloudResultCreateUserResponseDtoV2{}
	return &this
}
...
func (o *OBCloudResultCreateUserResponseDtoV2) GetData() CreateUserResponseDtoV2 {
	if o == nil || IsNil(o.Data) {
		var ret CreateUserResponseDtoV2
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given CreateUserResponseDtoV2 and assigns it to the Data field.
...
func (o OBCloudResultCreateUserResponseDtoV2) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultCreateUserResponseDtoV2) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultCreateUserResponseDtoV2 struct {
	value *OBCloudResultCreateUserResponseDtoV2
	isSet bool
}

func (v NullableOBCloudResultCreateUserResponseDtoV2) Get() *OBCloudResultCreateUserResponseDtoV2 {
	return v.value
}

func (v *NullableOBCloudResultCreateUserResponseDtoV2) Set(val *OBCloudResultCreateUserResponseDtoV2) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultCreateUserResponseDtoV2) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultCreateUserResponseDtoV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultCreateUserResponseDtoV2(val *OBCloudResultCreateUserResponseDtoV2) *NullableOBCloudResultCreateUserResponseDtoV2 {
	return &NullableOBCloudResultCreateUserResponseDtoV2{value: val, isSet: true}
}

func (v NullableOBCloudResultCreateUserResponseDtoV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultCreateUserResponseDtoV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
