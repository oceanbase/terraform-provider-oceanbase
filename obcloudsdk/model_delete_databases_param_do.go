...
// checks if the DeleteDatabasesParamDo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteDatabasesParamDo{}

// DeleteDatabasesParamDo struct for DeleteDatabasesParamDo
type DeleteDatabasesParamDo struct {
...
func (o *DeleteDatabasesParamDo) HasTenantId() bool {
	if o != nil && !IsNil(o.TenantId) {
		return true
	}
...
func (o *DeleteDatabasesParamDo) GetMergedCallerUid() string {
...
// and a boolean to check if the value has been set.
func (o *DeleteDatabasesParamDo) GetUidOk() (*string, bool) {
	if o == nil || IsNil(o.Uid) {
		return nil, false
	}
	return o.Uid, true
...
func (o DeleteDatabasesParamDo) MarshalJSON() ([]byte, error) {
...
func (o DeleteDatabasesParamDo) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteDatabasesParamDo struct {
	value *DeleteDatabasesParamDo
	isSet bool
}

func (v NullableDeleteDatabasesParamDo) Get() *DeleteDatabasesParamDo {
	return v.value
}

func (v *NullableDeleteDatabasesParamDo) Set(val *DeleteDatabasesParamDo) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteDatabasesParamDo) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteDatabasesParamDo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteDatabasesParamDo(val *DeleteDatabasesParamDo) *NullableDeleteDatabasesParamDo {
	return &NullableDeleteDatabasesParamDo{value: val, isSet: true}
}

func (v NullableDeleteDatabasesParamDo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteDatabasesParamDo) UnmarshalJSON(src []byte) error {
	v.isSet = true
