...
// checks if the OBCloudResultUpdateTenantPrivatelinkInformationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultUpdateTenantPrivatelinkInformationResponse{}

// OBCloudResultUpdateTenantPrivatelinkInformationResponse struct for OBCloudResultUpdateTenantPrivatelinkInformationResponse
type OBCloudResultUpdateTenantPrivatelinkInformationResponse struct {
...
func NewOBCloudResultUpdateTenantPrivatelinkInformationResponse() *OBCloudResultUpdateTenantPrivatelinkInformationResponse {
	this := OBCloudResultUpdateTenantPrivatelinkInformationResponse{}
	return &this
}
...
func (o *OBCloudResultUpdateTenantPrivatelinkInformationResponse) SetErrorMessage(v string) {
	o.ErrorMessage = &v
}
...
func (o OBCloudResultUpdateTenantPrivatelinkInformationResponse) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultUpdateTenantPrivatelinkInformationResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultUpdateTenantPrivatelinkInformationResponse struct {
	value *OBCloudResultUpdateTenantPrivatelinkInformationResponse
	isSet bool
}

func (v NullableOBCloudResultUpdateTenantPrivatelinkInformationResponse) Get() *OBCloudResultUpdateTenantPrivatelinkInformationResponse {
	return v.value
}

func (v *NullableOBCloudResultUpdateTenantPrivatelinkInformationResponse) Set(val *OBCloudResultUpdateTenantPrivatelinkInformationResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultUpdateTenantPrivatelinkInformationResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultUpdateTenantPrivatelinkInformationResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultUpdateTenantPrivatelinkInformationResponse(val *OBCloudResultUpdateTenantPrivatelinkInformationResponse) *NullableOBCloudResultUpdateTenantPrivatelinkInformationResponse {
	return &NullableOBCloudResultUpdateTenantPrivatelinkInformationResponse{value: val, isSet: true}
}

func (v NullableOBCloudResultUpdateTenantPrivatelinkInformationResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultUpdateTenantPrivatelinkInformationResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
