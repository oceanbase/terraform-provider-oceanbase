...
// checks if the CreateInstanceResponseV2OpenApi type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateInstanceResponseV2OpenApi{}

// CreateInstanceResponseV2OpenApi struct for CreateInstanceResponseV2OpenApi
type CreateInstanceResponseV2OpenApi struct {
...
func NewCreateInstanceResponseV2OpenApi() *CreateInstanceResponseV2OpenApi {
	this := CreateInstanceResponseV2OpenApi{}
	return &this
}
...
func (o CreateInstanceResponseV2OpenApi) MarshalJSON() ([]byte, error) {
...
func (o CreateInstanceResponseV2OpenApi) ToMap() (map[string]interface{}, error) {
...
type NullableCreateInstanceResponseV2OpenApi struct {
	value *CreateInstanceResponseV2OpenApi
	isSet bool
}

func (v NullableCreateInstanceResponseV2OpenApi) Get() *CreateInstanceResponseV2OpenApi {
	return v.value
}

func (v *NullableCreateInstanceResponseV2OpenApi) Set(val *CreateInstanceResponseV2OpenApi) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateInstanceResponseV2OpenApi) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateInstanceResponseV2OpenApi) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateInstanceResponseV2OpenApi(val *CreateInstanceResponseV2OpenApi) *NullableCreateInstanceResponseV2OpenApi {
	return &NullableCreateInstanceResponseV2OpenApi{value: val, isSet: true}
}

func (v NullableCreateInstanceResponseV2OpenApi) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateInstanceResponseV2OpenApi) UnmarshalJSON(src []byte) error {
	v.isSet = true
