...
// checks if the OBCloudResultDeleteInstanceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultDeleteInstanceResponse{}

// OBCloudResultDeleteInstanceResponse struct for OBCloudResultDeleteInstanceResponse
type OBCloudResultDeleteInstanceResponse struct {
...
func NewOBCloudResultDeleteInstanceResponse() *OBCloudResultDeleteInstanceResponse {
	this := OBCloudResultDeleteInstanceResponse{}
	return &this
}
...
func (o OBCloudResultDeleteInstanceResponse) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultDeleteInstanceResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultDeleteInstanceResponse struct {
	value *OBCloudResultDeleteInstanceResponse
	isSet bool
}

func (v NullableOBCloudResultDeleteInstanceResponse) Get() *OBCloudResultDeleteInstanceResponse {
	return v.value
}

func (v *NullableOBCloudResultDeleteInstanceResponse) Set(val *OBCloudResultDeleteInstanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultDeleteInstanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultDeleteInstanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultDeleteInstanceResponse(val *OBCloudResultDeleteInstanceResponse) *NullableOBCloudResultDeleteInstanceResponse {
	return &NullableOBCloudResultDeleteInstanceResponse{value: val, isSet: true}
}

func (v NullableOBCloudResultDeleteInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultDeleteInstanceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
