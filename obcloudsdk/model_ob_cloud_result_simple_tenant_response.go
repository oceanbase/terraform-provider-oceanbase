...
// checks if the OBCloudResultSimpleTenantResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultSimpleTenantResponse{}

// OBCloudResultSimpleTenantResponse struct for OBCloudResultSimpleTenantResponse
type OBCloudResultSimpleTenantResponse struct {
	Success *bool `json:"success,omitempty"`
	ErrorCode *string `json:"errorCode,omitempty"`
	ErrorMessage *string `json:"errorMessage,omitempty"`
	Data *SimpleTenantResponse `json:"data,omitempty"`
...
func NewOBCloudResultSimpleTenantResponse() *OBCloudResultSimpleTenantResponse {
	this := OBCloudResultSimpleTenantResponse{}
	return &this
}
...
// SetData gets a reference to the given SimpleTenantResponse and assigns it to the Data field.
...
func (o OBCloudResultSimpleTenantResponse) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultSimpleTenantResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultSimpleTenantResponse struct {
	value *OBCloudResultSimpleTenantResponse
	isSet bool
}

func (v NullableOBCloudResultSimpleTenantResponse) Get() *OBCloudResultSimpleTenantResponse {
	return v.value
}

func (v *NullableOBCloudResultSimpleTenantResponse) Set(val *OBCloudResultSimpleTenantResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultSimpleTenantResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultSimpleTenantResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultSimpleTenantResponse(val *OBCloudResultSimpleTenantResponse) *NullableOBCloudResultSimpleTenantResponse {
	return &NullableOBCloudResultSimpleTenantResponse{value: val, isSet: true}
}

func (v NullableOBCloudResultSimpleTenantResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultSimpleTenantResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
