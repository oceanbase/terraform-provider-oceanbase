...
// checks if the OBCloudResultModifyInstanceResponseV2OpenApi type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultModifyInstanceResponseV2OpenApi{}

// OBCloudResultModifyInstanceResponseV2OpenApi struct for OBCloudResultModifyInstanceResponseV2OpenApi
type OBCloudResultModifyInstanceResponseV2OpenApi struct {
	Success *bool `json:"success,omitempty"`
	ErrorCode *string `json:"errorCode,omitempty"`
	ErrorMessage *string `json:"errorMessage,omitempty"`
	Data *ModifyInstanceResponseV2OpenApi `json:"data,omitempty"`
...
func NewOBCloudResultModifyInstanceResponseV2OpenApi() *OBCloudResultModifyInstanceResponseV2OpenApi {
	this := OBCloudResultModifyInstanceResponseV2OpenApi{}
	return &this
}
...
func (o *OBCloudResultModifyInstanceResponseV2OpenApi) GetData() ModifyInstanceResponseV2OpenApi {
	if o == nil || IsNil(o.Data) {
		var ret ModifyInstanceResponseV2OpenApi
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ModifyInstanceResponseV2OpenApi and assigns it to the Data field.
...
func (o OBCloudResultModifyInstanceResponseV2OpenApi) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultModifyInstanceResponseV2OpenApi) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultModifyInstanceResponseV2OpenApi struct {
	value *OBCloudResultModifyInstanceResponseV2OpenApi
	isSet bool
}

func (v NullableOBCloudResultModifyInstanceResponseV2OpenApi) Get() *OBCloudResultModifyInstanceResponseV2OpenApi {
	return v.value
}

func (v *NullableOBCloudResultModifyInstanceResponseV2OpenApi) Set(val *OBCloudResultModifyInstanceResponseV2OpenApi) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultModifyInstanceResponseV2OpenApi) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultModifyInstanceResponseV2OpenApi) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultModifyInstanceResponseV2OpenApi(val *OBCloudResultModifyInstanceResponseV2OpenApi) *NullableOBCloudResultModifyInstanceResponseV2OpenApi {
	return &NullableOBCloudResultModifyInstanceResponseV2OpenApi{value: val, isSet: true}
}

func (v NullableOBCloudResultModifyInstanceResponseV2OpenApi) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultModifyInstanceResponseV2OpenApi) UnmarshalJSON(src []byte) error {
	v.isSet = true
