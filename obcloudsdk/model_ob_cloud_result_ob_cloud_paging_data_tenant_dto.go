...
// checks if the OBCloudResultOBCloudPagingDataTenantDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultOBCloudPagingDataTenantDTO{}

// OBCloudResultOBCloudPagingDataTenantDTO struct for OBCloudResultOBCloudPagingDataTenantDTO
type OBCloudResultOBCloudPagingDataTenantDTO struct {
	Success *bool `json:"success,omitempty"`
	ErrorCode *string `json:"errorCode,omitempty"`
	ErrorMessage *string `json:"errorMessage,omitempty"`
	Data *OBCloudPagingDataTenantDTO `json:"data,omitempty"`
...
func NewOBCloudResultOBCloudPagingDataTenantDTO() *OBCloudResultOBCloudPagingDataTenantDTO {
	this := OBCloudResultOBCloudPagingDataTenantDTO{}
	return &this
}
...
func (o *OBCloudResultOBCloudPagingDataTenantDTO) GetData() OBCloudPagingDataTenantDTO {
	if o == nil || IsNil(o.Data) {
		var ret OBCloudPagingDataTenantDTO
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given OBCloudPagingDataTenantDTO and assigns it to the Data field.
...
func (o OBCloudResultOBCloudPagingDataTenantDTO) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultOBCloudPagingDataTenantDTO) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultOBCloudPagingDataTenantDTO struct {
	value *OBCloudResultOBCloudPagingDataTenantDTO
	isSet bool
}

func (v NullableOBCloudResultOBCloudPagingDataTenantDTO) Get() *OBCloudResultOBCloudPagingDataTenantDTO {
	return v.value
}

func (v *NullableOBCloudResultOBCloudPagingDataTenantDTO) Set(val *OBCloudResultOBCloudPagingDataTenantDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultOBCloudPagingDataTenantDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultOBCloudPagingDataTenantDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultOBCloudPagingDataTenantDTO(val *OBCloudResultOBCloudPagingDataTenantDTO) *NullableOBCloudResultOBCloudPagingDataTenantDTO {
	return &NullableOBCloudResultOBCloudPagingDataTenantDTO{value: val, isSet: true}
}

func (v NullableOBCloudResultOBCloudPagingDataTenantDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultOBCloudPagingDataTenantDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
