...
// checks if the OBCloudResultTenantConnectionDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultTenantConnectionDTO{}

// OBCloudResultTenantConnectionDTO struct for OBCloudResultTenantConnectionDTO
type OBCloudResultTenantConnectionDTO struct {
...
func NewOBCloudResultTenantConnectionDTO() *OBCloudResultTenantConnectionDTO {
	this := OBCloudResultTenantConnectionDTO{}
	return &this
}
...
func (o OBCloudResultTenantConnectionDTO) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultTenantConnectionDTO) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultTenantConnectionDTO struct {
	value *OBCloudResultTenantConnectionDTO
	isSet bool
}

func (v NullableOBCloudResultTenantConnectionDTO) Get() *OBCloudResultTenantConnectionDTO {
	return v.value
}

func (v *NullableOBCloudResultTenantConnectionDTO) Set(val *OBCloudResultTenantConnectionDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultTenantConnectionDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultTenantConnectionDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultTenantConnectionDTO(val *OBCloudResultTenantConnectionDTO) *NullableOBCloudResultTenantConnectionDTO {
	return &NullableOBCloudResultTenantConnectionDTO{value: val, isSet: true}
}

func (v NullableOBCloudResultTenantConnectionDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultTenantConnectionDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
