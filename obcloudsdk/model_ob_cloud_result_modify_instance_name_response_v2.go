...
// checks if the OBCloudResultModifyInstanceNameResponseV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultModifyInstanceNameResponseV2{}

// OBCloudResultModifyInstanceNameResponseV2 struct for OBCloudResultModifyInstanceNameResponseV2
type OBCloudResultModifyInstanceNameResponseV2 struct {
	Success *bool `json:"success,omitempty"`
	ErrorCode *string `json:"errorCode,omitempty"`
	ErrorMessage *string `json:"errorMessage,omitempty"`
	Data *ModifyInstanceNameResponseV2 `json:"data,omitempty"`
...
func NewOBCloudResultModifyInstanceNameResponseV2() *OBCloudResultModifyInstanceNameResponseV2 {
	this := OBCloudResultModifyInstanceNameResponseV2{}
	return &this
}
...
func (o *OBCloudResultModifyInstanceNameResponseV2) GetData() ModifyInstanceNameResponseV2 {
	if o == nil || IsNil(o.Data) {
		var ret ModifyInstanceNameResponseV2
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ModifyInstanceNameResponseV2 and assigns it to the Data field.
...
func (o OBCloudResultModifyInstanceNameResponseV2) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultModifyInstanceNameResponseV2) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultModifyInstanceNameResponseV2 struct {
	value *OBCloudResultModifyInstanceNameResponseV2
	isSet bool
}

func (v NullableOBCloudResultModifyInstanceNameResponseV2) Get() *OBCloudResultModifyInstanceNameResponseV2 {
	return v.value
}

func (v *NullableOBCloudResultModifyInstanceNameResponseV2) Set(val *OBCloudResultModifyInstanceNameResponseV2) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultModifyInstanceNameResponseV2) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultModifyInstanceNameResponseV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultModifyInstanceNameResponseV2(val *OBCloudResultModifyInstanceNameResponseV2) *NullableOBCloudResultModifyInstanceNameResponseV2 {
	return &NullableOBCloudResultModifyInstanceNameResponseV2{value: val, isSet: true}
}

func (v NullableOBCloudResultModifyInstanceNameResponseV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultModifyInstanceNameResponseV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
