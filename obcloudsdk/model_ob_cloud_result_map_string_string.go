...
// checks if the OBCloudResultMapStringString type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultMapStringString{}

// OBCloudResultMapStringString struct for OBCloudResultMapStringString
type OBCloudResultMapStringString struct {
...
func NewOBCloudResultMapStringString() *OBCloudResultMapStringString {
	this := OBCloudResultMapStringString{}
	return &this
}
...
func (o OBCloudResultMapStringString) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultMapStringString) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultMapStringString struct {
	value *OBCloudResultMapStringString
	isSet bool
}

func (v NullableOBCloudResultMapStringString) Get() *OBCloudResultMapStringString {
	return v.value
}

func (v *NullableOBCloudResultMapStringString) Set(val *OBCloudResultMapStringString) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultMapStringString) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultMapStringString) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultMapStringString(val *OBCloudResultMapStringString) *NullableOBCloudResultMapStringString {
	return &NullableOBCloudResultMapStringString{value: val, isSet: true}
}

func (v NullableOBCloudResultMapStringString) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultMapStringString) UnmarshalJSON(src []byte) error {
	v.isSet = true
