...
// checks if the OBCloudPagingDataTenantDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudPagingDataTenantDTO{}

// OBCloudPagingDataTenantDTO struct for OBCloudPagingDataTenantDTO
type OBCloudPagingDataTenantDTO struct {
	DataList []TenantDTO `json:"dataList,omitempty"`
...
func NewOBCloudPagingDataTenantDTO() *OBCloudPagingDataTenantDTO {
	this := OBCloudPagingDataTenantDTO{}
	return &this
}
...
// SetDataList gets a reference to the given []TenantDTO and assigns it to the DataList field.
...
func (o OBCloudPagingDataTenantDTO) MarshalJSON() ([]byte, error) {
...
func (o OBCloudPagingDataTenantDTO) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudPagingDataTenantDTO struct {
	value *OBCloudPagingDataTenantDTO
	isSet bool
}

func (v NullableOBCloudPagingDataTenantDTO) Get() *OBCloudPagingDataTenantDTO {
	return v.value
}

func (v *NullableOBCloudPagingDataTenantDTO) Set(val *OBCloudPagingDataTenantDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudPagingDataTenantDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudPagingDataTenantDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudPagingDataTenantDTO(val *OBCloudPagingDataTenantDTO) *NullableOBCloudPagingDataTenantDTO {
	return &NullableOBCloudPagingDataTenantDTO{value: val, isSet: true}
}

func (v NullableOBCloudPagingDataTenantDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudPagingDataTenantDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
