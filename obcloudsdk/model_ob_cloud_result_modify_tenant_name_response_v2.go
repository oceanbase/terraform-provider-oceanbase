...
// checks if the OBCloudResultModifyTenantNameResponseV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultModifyTenantNameResponseV2{}

// OBCloudResultModifyTenantNameResponseV2 struct for OBCloudResultModifyTenantNameResponseV2
type OBCloudResultModifyTenantNameResponseV2 struct {
	Success *bool `json:"success,omitempty"`
	ErrorCode *string `json:"errorCode,omitempty"`
	ErrorMessage *string `json:"errorMessage,omitempty"`
	Data *ModifyTenantNameResponseV2 `json:"data,omitempty"`
...
func NewOBCloudResultModifyTenantNameResponseV2() *OBCloudResultModifyTenantNameResponseV2 {
	this := OBCloudResultModifyTenantNameResponseV2{}
	return &this
}
...
func (o *OBCloudResultModifyTenantNameResponseV2) GetData() ModifyTenantNameResponseV2 {
	if o == nil || IsNil(o.Data) {
		var ret ModifyTenantNameResponseV2
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ModifyTenantNameResponseV2 and assigns it to the Data field.
...
func (o OBCloudResultModifyTenantNameResponseV2) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultModifyTenantNameResponseV2) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultModifyTenantNameResponseV2 struct {
	value *OBCloudResultModifyTenantNameResponseV2
	isSet bool
}

func (v NullableOBCloudResultModifyTenantNameResponseV2) Get() *OBCloudResultModifyTenantNameResponseV2 {
	return v.value
}

func (v *NullableOBCloudResultModifyTenantNameResponseV2) Set(val *OBCloudResultModifyTenantNameResponseV2) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultModifyTenantNameResponseV2) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultModifyTenantNameResponseV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultModifyTenantNameResponseV2(val *OBCloudResultModifyTenantNameResponseV2) *NullableOBCloudResultModifyTenantNameResponseV2 {
	return &NullableOBCloudResultModifyTenantNameResponseV2{value: val, isSet: true}
}

func (v NullableOBCloudResultModifyTenantNameResponseV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultModifyTenantNameResponseV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
