...
// checks if the OBCloudResultCreateReadonlyConnectionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultCreateReadonlyConnectionResponse{}

// OBCloudResultCreateReadonlyConnectionResponse struct for OBCloudResultCreateReadonlyConnectionResponse
type OBCloudResultCreateReadonlyConnectionResponse struct {
	Success *bool `json:"success,omitempty"`
	ErrorCode *string `json:"errorCode,omitempty"`
	ErrorMessage *string `json:"errorMessage,omitempty"`
	Data *CreateReadonlyConnectionResponse `json:"data,omitempty"`
...
func NewOBCloudResultCreateReadonlyConnectionResponse() *OBCloudResultCreateReadonlyConnectionResponse {
	this := OBCloudResultCreateReadonlyConnectionResponse{}
	return &this
}
...
func (o *OBCloudResultCreateReadonlyConnectionResponse) GetData() CreateReadonlyConnectionResponse {
	if o == nil || IsNil(o.Data) {
		var ret CreateReadonlyConnectionResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given CreateReadonlyConnectionResponse and assigns it to the Data field.
...
func (o OBCloudResultCreateReadonlyConnectionResponse) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultCreateReadonlyConnectionResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultCreateReadonlyConnectionResponse struct {
	value *OBCloudResultCreateReadonlyConnectionResponse
	isSet bool
}

func (v NullableOBCloudResultCreateReadonlyConnectionResponse) Get() *OBCloudResultCreateReadonlyConnectionResponse {
	return v.value
}

func (v *NullableOBCloudResultCreateReadonlyConnectionResponse) Set(val *OBCloudResultCreateReadonlyConnectionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultCreateReadonlyConnectionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultCreateReadonlyConnectionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultCreateReadonlyConnectionResponse(val *OBCloudResultCreateReadonlyConnectionResponse) *NullableOBCloudResultCreateReadonlyConnectionResponse {
	return &NullableOBCloudResultCreateReadonlyConnectionResponse{value: val, isSet: true}
}

func (v NullableOBCloudResultCreateReadonlyConnectionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultCreateReadonlyConnectionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
