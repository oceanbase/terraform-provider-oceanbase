...
// checks if the ModifyUserRolesParamDo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyUserRolesParamDo{}

// ModifyUserRolesParamDo struct for ModifyUserRolesParamDo
type ModifyUserRolesParamDo struct {
...
func (o *ModifyUserRolesParamDo) HasTenantId() bool {
	if o != nil && !IsNil(o.TenantId) {
		return true
	}
...
func (o *ModifyUserRolesParamDo) SetUid(v string) {
	o.Uid = &v
}

func (o ModifyUserRolesParamDo) MarshalJSON() ([]byte, error) {
...
func (o ModifyUserRolesParamDo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ModifyType) {
		toSerialize["modifyType"] = o.ModifyType
	}
...
type NullableModifyUserRolesParamDo struct {
	value *ModifyUserRolesParamDo
	isSet bool
}

func (v NullableModifyUserRolesParamDo) Get() *ModifyUserRolesParamDo {
	return v.value
}

func (v *NullableModifyUserRolesParamDo) Set(val *ModifyUserRolesParamDo) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyUserRolesParamDo) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyUserRolesParamDo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyUserRolesParamDo(val *ModifyUserRolesParamDo) *NullableModifyUserRolesParamDo {
	return &NullableModifyUserRolesParamDo{value: val, isSet: true}
}

func (v NullableModifyUserRolesParamDo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyUserRolesParamDo) UnmarshalJSON(src []byte) error {
	v.isSet = true
