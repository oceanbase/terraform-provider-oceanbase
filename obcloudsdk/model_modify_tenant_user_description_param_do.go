...
// checks if the ModifyTenantUserDescriptionParamDo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyTenantUserDescriptionParamDo{}

// ModifyTenantUserDescriptionParamDo struct for ModifyTenantUserDescriptionParamDo
type ModifyTenantUserDescriptionParamDo struct {
...
func NewModifyTenantUserDescriptionParamDo() *ModifyTenantUserDescriptionParamDo {
	this := ModifyTenantUserDescriptionParamDo{}
	return &this
}
...
func (o *ModifyTenantUserDescriptionParamDo) HasTenantId() bool {
	if o != nil && !IsNil(o.TenantId) {
		return true
	}
...
func (o ModifyTenantUserDescriptionParamDo) MarshalJSON() ([]byte, error) {
...
func (o ModifyTenantUserDescriptionParamDo) ToMap() (map[string]interface{}, error) {
...
type NullableModifyTenantUserDescriptionParamDo struct {
	value *ModifyTenantUserDescriptionParamDo
	isSet bool
}

func (v NullableModifyTenantUserDescriptionParamDo) Get() *ModifyTenantUserDescriptionParamDo {
	return v.value
}

func (v *NullableModifyTenantUserDescriptionParamDo) Set(val *ModifyTenantUserDescriptionParamDo) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyTenantUserDescriptionParamDo) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyTenantUserDescriptionParamDo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyTenantUserDescriptionParamDo(val *ModifyTenantUserDescriptionParamDo) *NullableModifyTenantUserDescriptionParamDo {
	return &NullableModifyTenantUserDescriptionParamDo{value: val, isSet: true}
}

func (v NullableModifyTenantUserDescriptionParamDo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyTenantUserDescriptionParamDo) UnmarshalJSON(src []byte) error {
	v.isSet = true
