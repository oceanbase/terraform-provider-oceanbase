...
// checks if the OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse{}

// OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse struct for OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse
type OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse struct {
	Success *bool `json:"success,omitempty"`
	ErrorCode *string `json:"errorCode,omitempty"`
	ErrorMessage *string `json:"errorMessage,omitempty"`
	Data *OBCloudPagingDataMcTenantSecurityIpGroupsResponse `json:"data,omitempty"`
...
func NewOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse() *OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse {
	this := OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse{}
	return &this
}
...
func (o *OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) GetSuccessOk() (*bool, bool) {
	if o == nil || IsNil(o.Success) {
		return nil, false
	}
...
func (o *OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) GetData() OBCloudPagingDataMcTenantSecurityIpGroupsResponse {
	if o == nil || IsNil(o.Data) {
		var ret OBCloudPagingDataMcTenantSecurityIpGroupsResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given OBCloudPagingDataMcTenantSecurityIpGroupsResponse and assigns it to the Data field.
...
func (o *OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) SetCost(v int64) {
	o.Cost = &v
}
...
func (o *OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) HasRequestId() bool {
	if o != nil && !IsNil(o.RequestId) {
		return true
	}
...
func (o OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse struct {
	value *OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse
	isSet bool
}

func (v NullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) Get() *OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse {
	return v.value
}

func (v *NullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) Set(val *OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse(val *OBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) *NullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse {
	return &NullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse{value: val, isSet: true}
}

func (v NullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultOBCloudPagingDataMcTenantSecurityIpGroupsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
