...
// checks if the OBCloudResultString type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultString{}

// OBCloudResultString struct for OBCloudResultString
type OBCloudResultString struct {
...
// and a boolean to check if the value has been set.
func (o *OBCloudResultString) GetServerOk() (*string, bool) {
	if o == nil || IsNil(o.Server) {
		return nil, false
	}
...
func (o *OBCloudResultString) SetTotalCount(v int64) {
	o.TotalCount = &v
}
...
func (o OBCloudResultString) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultString) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultString struct {
	value *OBCloudResultString
	isSet bool
}

func (v NullableOBCloudResultString) Get() *OBCloudResultString {
	return v.value
}

func (v *NullableOBCloudResultString) Set(val *OBCloudResultString) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultString) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultString) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultString(val *OBCloudResultString) *NullableOBCloudResultString {
	return &NullableOBCloudResultString{value: val, isSet: true}
}

func (v NullableOBCloudResultString) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultString) UnmarshalJSON(src []byte) error {
	v.isSet = true
