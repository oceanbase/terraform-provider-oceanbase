...
// checks if the OBCloudResultBoolean type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OBCloudResultBoolean{}

// OBCloudResultBoolean struct for OBCloudResultBoolean
type OBCloudResultBoolean struct {
...
func (o OBCloudResultBoolean) MarshalJSON() ([]byte, error) {
...
func (o OBCloudResultBoolean) ToMap() (map[string]interface{}, error) {
...
type NullableOBCloudResultBoolean struct {
	value *OBCloudResultBoolean
	isSet bool
}

func (v NullableOBCloudResultBoolean) Get() *OBCloudResultBoolean {
	return v.value
}

func (v *NullableOBCloudResultBoolean) Set(val *OBCloudResultBoolean) {
	v.value = val
	v.isSet = true
}

func (v NullableOBCloudResultBoolean) IsSet() bool {
	return v.isSet
}

func (v *NullableOBCloudResultBoolean) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOBCloudResultBoolean(val *OBCloudResultBoolean) *NullableOBCloudResultBoolean {
	return &NullableOBCloudResultBoolean{value: val, isSet: true}
}

func (v NullableOBCloudResultBoolean) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOBCloudResultBoolean) UnmarshalJSON(src []byte) error {
	v.isSet = true
